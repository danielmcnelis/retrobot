...
client.on('message', async message => {
    ...
    if(cmd === `!mod`) {
        ...
        const botEmbed = new Discord.RichEmbed()
	        ...
	        .setAuthor('Jazz#2704', 'https://i.imgur.com/93IC0Ua.png', 'https://formatlibrary.com/')
        	.setThumbnail('https://i.imgur.com/9lMCJJH.png')
        	.addField('Mod Only Commands', 'The following commands require arguments as follows: (blank) no argument, (@user) mention a user, (n) a number, (link)  a URL. ')
